...
var menus = []model.SysBaseMenu{
	...
	{TENANCY_MODEL: g.TENANCY_MODEL{ID: 3, CreatedAt: time.Now(), UpdatedAt: time.Now()}, MenuLevel: 0, Hidden: false, ParentId: "0", Path: "admin", Name: "superAdmin", Component: "view/superAdmin/index.vue", Sort: 3, Meta: model.Meta{Title: "系统管理", Icon: "user-solid"}},
	...
	{TENANCY_MODEL: g.TENANCY_MODEL{ID: 8, CreatedAt: time.Now(), UpdatedAt: time.Now()}, MenuLevel: 0, Hidden: false, ParentId: "3", Path: "config", Name: "config", Component: "view/superAdmin/config/index.vue", Sort: 15, Meta: model.Meta{Title: "系统配置管理", Icon: "coordinate"}},
	{TENANCY_MODEL: g.TENANCY_MODEL{ID: 9, CreatedAt: time.Now(), UpdatedAt: time.Now()}, MenuLevel: 0, Hidden: false, ParentId: "3", Path: "mini", Name: "mini", Component: "view/superAdmin/mini/index.vue", Sort: 8, Meta: model.Meta{Title: "小程序管理", Icon: "coordinate"}},
	{TENANCY_MODEL: g.TENANCY_MODEL{ID: 10, CreatedAt: time.Now(), UpdatedAt: time.Now()}, MenuLevel: 0, Hidden: false, ParentId: "3", Path: "operation", Name: "operation", Component: "view/superAdmin/operation/sysOperationRecord.vue", Sort: 20, Meta: model.Meta{Title: "操作历史", Icon: "time"}},

	{TENANCY_MODEL: g.TENANCY_MODEL{ID: 11, CreatedAt: time.Now(), UpdatedAt: time.Now()}, MenuLevel: 0, ParentId: "3", Path: "state", Name: "state", Hidden: false, Component: "view/system/state.vue", Sort: 6, Meta: model.Meta{Title: "服务器状态", Icon: "cloudy"}},

	{TENANCY_MODEL: g.TENANCY_MODEL{ID: 21, CreatedAt: time.Now(), UpdatedAt: time.Now()}, MenuLevel: 0, Hidden: false, ParentId: "0", Path: "tenancy", Name: "tenancy", Component: "view/tenancy/index.vue", Sort: 7, Meta: model.Meta{Title: "店铺管理", Icon: "coordinate"}},
	{TENANCY_MODEL: g.TENANCY_MODEL{ID: 22, CreatedAt: time.Now(), UpdatedAt: time.Now()}, MenuLevel: 0, Hidden: false, ParentId: "21", Path: "tenancy", Name: "tenancy", Component: "view/tenancy/tenancy.vue", Sort: 7, Meta: model.Meta{Title: "商户管理", Icon: "coordinate"}},
	{TENANCY_MODEL: g.TENANCY_MODEL{ID: 23, CreatedAt: time.Now(), UpdatedAt: time.Now()}, MenuLevel: 0, Hidden: false, ParentId: "21", Path: "brand", Name: "brand", Component: "view/tenancy/brand.vue", Sort: 9, Meta: model.Meta{Title: "品牌管理", Icon: "coordinate"}},
	{TENANCY_MODEL: g.TENANCY_MODEL{ID: 24, CreatedAt: time.Now(), UpdatedAt: time.Now()}, MenuLevel: 0, Hidden: false, ParentId: "21", Path: "brandCategory", Name: "brandCategory", Component: "view/tenancy/brandCategory.vue", Sort: 10, Meta: model.Meta{Title: "品牌分类管理", Icon: "coordinate"}},
	{TENANCY_MODEL: g.TENANCY_MODEL{ID: 25, CreatedAt: time.Now(), UpdatedAt: time.Now()}, MenuLevel: 0, Hidden: false, ParentId: "21", Path: "media", Name: "media", Component: "view/tenancy/media.vue", Sort: 11, Meta: model.Meta{Title: "媒体库", Icon: "upload"}},
