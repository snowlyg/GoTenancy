...
var apis = []model.SysApi{
	...
	{TENANCY_MODEL: g.TENANCY_MODEL{ID: 27, CreatedAt: time.Now(), UpdatedAt: time.Now()}, Path: "/v1/auth/logout", Description: "退出", ApiGroup: "user", Method: "GET"},
	{TENANCY_MODEL: g.TENANCY_MODEL{ID: 28, CreatedAt: time.Now(), UpdatedAt: time.Now()}, Path: "/v1/auth/clean", Description: "清空", ApiGroup: "user", Method: "GET"},
