...
var admins = []model.SysUser{
	...
	{TENANCY_MODEL: g.TENANCY_MODEL{ID: 2, CreatedAt: time.Now(), UpdatedAt: time.Now()}, Username: "a303176530", Password: "e10adc3949ba59abbe56e057f20f883e", AuthorityId: TenancyAuthorityId, TenancyInfo: model.SysTenancyInfo{TENANCY_MODEL: g.TENANCY_MODEL{ID: 1, CreatedAt: time.Now(), UpdatedAt: time.Now()}, Email: "a303176530@admin.com", Phone: "13800138000", NickName: "商户管理员", SysUserID: 2, SysTenancyID: 1}},
	{TENANCY_MODEL: g.TENANCY_MODEL{ID: 3, CreatedAt: time.Now(), UpdatedAt: time.Now()}, Username: "oZM5VwD_PCaPKQZ8zRGt-NUdU2uM", Password: "e10adc3949ba59abbe56e057f20f883e", AuthorityId: GeneralAuthorityId, GeneralInfo: model.SysGeneralInfo{TENANCY_MODEL: g.TENANCY_MODEL{ID: 1, CreatedAt: time.Now(), UpdatedAt: time.Now()}, Email: "a303176530@admin.com", Phone: "13800138000", NickName: "C端用户", SysUserID: 3, AvatarUrl: "https://thirdwx.qlogo.cn/mmopen/vi_32/PEyYoZmTJtaJdeYWWibrnDUadmXKVYyTtyRq2nxtWbBic5jJTLTT4KHmox1tNvOicgIXxspgmxicghpCFob1icAIWFw/132", Sex: model.Female, Subscribe: 1, OpenId: "own1t5TysymNUqcZm-8giuEvT68M", UnionId: "oZM5VwCgvGUZvkrnrGrdJZI4e12k", IdCard: "445281199411285861", IsAuth: 0, Birthday: birthday, RealName: "余思琳"}},
}
