...
var products = []model.Product{
	...
	{BaseProduct: model.BaseProduct{SysTenancyID: 1, StoreName: "天丝一字领露肩上衣", StoreInfo: "天丝一字领露肩上衣", Keyword: "测试", BarCode: "", SysBrandID: 2, IsShow: 1, Status: 1, ProductCategoryID: 1, UnitName: "件", Sort: 10, Rank: 0, Sales: 1, Price: 50.00, Cost: 20.00, OtPrice: 100.00, Stock: 99, IsHot: 2, IsBest: 2, IsNew: 2, IsGood: 1, ProductType: 2, Ficti: 100, Browse: 0, CodePath: "", VideoLink: "", TempID: 102, SpecType: 2, ExtensionType: 2, Refusal: "", Rate: 5.0, ReplyCount: 0, IsGiftBag: 0, CareCount: 1, OldID: 0, Image: ""}, TENANCY_MODEL: g.TENANCY_MODEL{DeletedAt: gorm.DeletedAt{Time: time.Now()}}, SliderImage: ""},
