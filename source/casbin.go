...
var carbines = []gormadapter.CasbinRule{
	...
	{Ptype: "p", V0: AdminAuthorityId, V1: "/v1/admin/sysDictionaryDetail/createSysDictionaryDetail", V2: "POST"},
	{Ptype: "p", V0: AdminAuthorityId, V1: "/v1/admin/sysDictionaryDetail/deleteSysDictionaryDetail", V2: "DELETE"},
	{Ptype: "p", V0: AdminAuthorityId, V1: "/v1/admin/sysDictionaryDetail/updateSysDictionaryDetail", V2: "PUT"},
	{Ptype: "p", V0: AdminAuthorityId, V1: "/v1/admin/sysDictionaryDetail/findSysDictionaryDetail", V2: "GET"},
	{Ptype: "p", V0: AdminAuthorityId, V1: "/v1/admin/sysDictionaryDetail/getSysDictionaryDetailList", V2: "GET"},
	{Ptype: "p", V0: AdminAuthorityId, V1: "/v1/admin/sysDictionary/createSysDictionary", V2: "POST"},
	{Ptype: "p", V0: AdminAuthorityId, V1: "/v1/admin/sysDictionary/deleteSysDictionary", V2: "DELETE"},
	{Ptype: "p", V0: AdminAuthorityId, V1: "/v1/admin/sysDictionary/updateSysDictionary", V2: "PUT"},
	{Ptype: "p", V0: AdminAuthorityId, V1: "/v1/admin/sysDictionary/findSysDictionary", V2: "GET"},
	{Ptype: "p", V0: AdminAuthorityId, V1: "/v1/admin/sysDictionary/getSysDictionaryList", V2: "GET"},
