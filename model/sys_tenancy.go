...
type BaseTenancy struct {
	...
	IsAudit        uint8   `gorm:"column:is_audit;type:tinyint unsigned;not null;default:0" json:"isAudit"`        // 添加的产品是否审核0不审核1审核
	IsBroRoom      uint8   `gorm:"column:is_bro_room;type:tinyint unsigned;not null;default:1" json:"isBroRoom"`   // 是否审核直播间0不审核1审核
	IsBroGoods     uint8   `gorm:"column:is_bro_goods;type:tinyint unsigned;not null;default:1" json:"isBroGoods"` // 是否审核直播商品0不审核1审核
	IsBest         uint8   `gorm:"column:is_best;type:tinyint unsigned;not null;default:0" json:"isBest"`          // 是否推荐
	IsTrader       uint8   `gorm:"column:is_trader;type:tinyint unsigned;not null;default:0" json:"isTrader"`      // 是否自营
	State          uint8   `gorm:"column:state;type:tinyint unsigned;not null;default:0" json:"State"`             // 商户是否1开启0关闭
