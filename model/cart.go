...
type Cart struct {
	...
	ProductType       int8   `gorm:"column:product_type;type:tinyint;not null;default:1" json:"productType"`                   // 类型 1=普通产品，2.预售商品
	...
	IsPay             bool   `gorm:"column:is_pay;type:tinyint(1);not null;default:2" json:"isPay"`                            // 2 = 未购买 1 = 已购买
	IsDel             bool   `gorm:"column:is_del;type:tinyint(1);not null;default:2" json:"isDel"`                            // 是否删除
	IsNew             bool   `gorm:"column:is_new;type:tinyint(1);not null;default:2" json:"isNew"`                            // 是否为立即购买
	IsFail            uint8  `gorm:"column:is_fail;type:tinyint unsigned;not null;default:2" json:"isFail"`                    // 是否失效
