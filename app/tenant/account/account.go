...
func (App) ConfigureAdmin(Tenant *admin.Admin) {
	Tenant.AddMenu(&admin.Menu{Name: "User Management", Priority: 3})
	user := Tenant.AddResource(&users.User{}, &admin.Config{Menu: []string{"User Management"}})
