...
func SetupDashboard(Tenant *admin.Admin) {
	// Add Dashboard
	Tenant.AddMenu(&admin.Menu{Name: "Dashboard", Link: "/", Priority: 1, IconName: "Dashboard"})

	Tenant.GetRouter().Get("/reports", ReportsDataHandler)
	initFuncMap(Tenant)
}
