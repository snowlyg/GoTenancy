...
func initFuncMap(Tenant *admin.Admin) {
	Tenant.RegisterFuncMap("render_latest_order", renderLatestOrder)
	Tenant.RegisterFuncMap("render_latest_products", renderLatestProduct)
}
