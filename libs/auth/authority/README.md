...
It is based on [Roles](http://GoTenancy/libs/roles), means to define an ability, you need to register a role with `Roles`, refer [Roles](http://GoTenancy/libs/roles) for how to do that.

## Usage

### Initialize Authority

Authority could use with [Auth](http://GoTenancy/libs/auth) to get current user, handle sessions, you could use it, or implement your own [AuthInterface](http://godoc.org/GoTenancy/libs/auth/authority#AuthInterface)
...
Refer [Roles](http://GoTenancy/libs/roles) for how to use roles to register roles, here is a sample:
...
Authority provides some [Rules](http://godoc.org/GoTenancy/libs/auth/authority#Rule) to make you define them easily, used like:
